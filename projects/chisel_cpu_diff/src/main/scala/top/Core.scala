...
class Core extends Module {
  ...
  dt_ic.io.skip := RegNext(fetch.io.if_to_id.inst === "h0000007b".U || lsu.io.lsu_to_csr.is_clint || fetch.io.if_to_id.inst === ECALL) || (fetch.io.if_to_id.inst === "h0000007b".U && csr.io.cause === "hb".U)
